...
const data = ({ moviedata, setsource, isReleased }) => {
  ...
  return (
    ...
    >
      ...
      <div className="outline-1 px-6 outline-white/30 w-auto  h-fit rounded-sm md:rounded-2xl bg-black/20 py-4 md:py-10 flex justify-center flex-col-reverse 2xl:flex-row gap-5">
