...
const HomeSkeleton = () => {
  ...
  return (
    <div className="w-fit flex flex-col pb-10 items-center animate-pulse">
      {/* Cards Grid Skeleton */}
      <div className="w-[90%] py-8 h-fit flex flex-wrap gap-4 md:gap-10">
        {skeletonCards.map((_, index) =>
          ismobile ? (
            /* Mobile Card Skeleton — horizontal layout matching Card mobile view */
            <div
              key={index}
            ...
            /* Desktop Card Skeleton — poster layout matching Card desktop view */
            <div
              key={index}
